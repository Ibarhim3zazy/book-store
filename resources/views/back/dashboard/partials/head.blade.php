<head>
    ...
    <link rel="icon" href="{{ asset('assets-dashboard') }}/images/dashboard/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('assets-dashboard') }}/images/dashboard/favicon.png" type="image/x-icon">
    <title>boox4read - @yield('title')</title>
    ...
    <!-- Prism css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets-dashboard') }}/css/vendors/prism.css">

    <!-- Chartist css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets-dashboard') }}/css/vendors/chartist.css">
