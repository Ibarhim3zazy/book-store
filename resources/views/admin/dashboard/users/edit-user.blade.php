                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="name"
                                            value="{{  old('name') ?? $user->name }}" id="validationCustom0" type="text"
                                            required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="email"
                                            value="{{ old('email') ?? $user->email }}" id="validationCustom2"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="phone"
                                            value="{{ old('phone') ?? $user->phone }}" id="validationCustom2"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="address"
                                            value="{{ old('address') ?? $user->address }}" id="validationCustom2"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="state"
                                            value="{{ old('state') ?? $user->state }}" id="validationCustom2"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="country"
                                            value="{{ old('country') ?? $user->country }}" id="validationCustom2"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="location"
                                            value="{{ old('location') ?? $user->location }}" id="validationCustom2"
                                            type="text" required="">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <select class="form-control" name="gender" id="">
                                            <option value="male" {{ old('gender')=='male' ? 'selected' :
                                                (old('gender')!='female' && $user->gender
                                                == 'male' ? 'selected' : '') }} >Male</option>
                                            <option value="female" {{ old('gender')=='female' ? 'selected' :
                                                (old('gender')!='male' && $user->gender
