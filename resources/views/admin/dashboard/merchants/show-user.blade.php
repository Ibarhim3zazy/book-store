...
@section('title', 'Dashboard | Show Merchant')

@section('fluid-title', 'Show Merchant')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="profile-details text-center">
                        <img src="{{ getFileUrl('merchants/profile', $merchant->image) }}" alt=""
                            class="img-fluid img-90 rounded-circle blur-up lazyloaded">
                        <h5 class="f-w-600 mb-0">{{ $merchant->name }}</h5>
