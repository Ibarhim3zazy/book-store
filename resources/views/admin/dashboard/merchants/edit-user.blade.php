...
@section('title', 'Dashboard | Create Merchant')

@section('fluid-title', 'Create Merchant')
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="account" role="tabpanel"
                            ...
                            <form class="needs-validation merchant-add" method="POST"
                                action="{{ route('admin.dashboard.merchants.update', $merchant) }}" novalidate=""
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="name"
                                            value="{{  old('name') ?? $merchant->name }}" id="validationCustom0"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="email"
                                            value="{{ old('email') ?? $merchant->email }}" id="validationCustom2"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="phone"
                                            value="{{ old('phone') ?? $merchant->phone }}" id="validationCustom2"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="address"
                                            value="{{ old('address') ?? $merchant->address }}" id="validationCustom2"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="city"
                                            value="{{ old('city') ?? $merchant->city }}" id="validationCustom2"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="state"
                                            value="{{ old('state') ?? $merchant->state }}" id="validationCustom2"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="country"
                                            value="{{ old('country') ?? $merchant->country }}" id="validationCustom2"
                                            type="text" required="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="location"
                                            value="{{ old('location') ?? $merchant->location }}" id="validationCustom2"
                                            type="text" required="">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <select class="form-control" name="gender" id="">
                                            <option value="male" {{ old('gender')=='male' ? 'selected' :
                                                (old('gender')!='female' && $merchant->gender
                                                == 'male' ? 'selected' : '') }} >Male</option>
                                            <option value="female" {{ old('gender')=='female' ? 'selected' :
                                                (old('gender')!='male' && $merchant->gender
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control" name="date_of_birth"
                                            value="{{ old('date_of_birth') ?? $merchant->date_of_birth }}"
                                ...
                                <div class="form-group row">
                                    <label for="validationCustom4" class="col-xl-3 col-md-4"> Confirm
                                        Password</label>
                                    <div class="col-xl-8 col-md-7">
