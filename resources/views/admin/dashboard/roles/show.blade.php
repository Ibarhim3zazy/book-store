@extends('role.dashboard.master')

@section('title', 'Dashboard | Show Role')

@section('fluid-title', 'Show Role')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="profile-details text-center">
                        <img src="{{ getFileUrl('roles/profile', $role->image) }}" alt=""
                            class="img-fluid img-90 rounded-circle blur-up lazyloaded">
                        <h5 class="f-w-600 mb-0">{{ $role->name }}</h5>
