<head>
    ...
    <link rel="icon" href="{{ asset('assets-front') }}/images/favicon/22.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('assets-front') }}/images/favicon/22.png" type="image/x-icon">
