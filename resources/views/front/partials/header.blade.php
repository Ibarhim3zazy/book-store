                ...
                <div class="main-menu">
                    <div class="menu-left">
                        ...
                        <div class="brand-logo">
                            <a href="index.html"><img src="{{ asset('assets-front') }}/images/icon/logo/f11.png"
                        ...
                        <div class="top-header d-block">
                            <ul class="header-dropdown">
                                <li class="mobile-wishlist"><a href="#"><img
                                            src="{{ asset('assets-front') }}/images/icon/white-icon/heart.png" alt="">
                                    </a></li>
                                <li class="onhover-dropdown mobile-account">
                                    <a href="login.html">
                                        <img src="{{ asset('assets-front') }}/images/icon/white-icon/user.png" alt="">
                                    </a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        ...
                                        <ul class="show-div shopping-cart">
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img alt="" class="me-3"
                                                            src="{{ asset('assets-front') }}/images/fashion/product/1.jpg"></a>
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img alt="" class="me-3"
                                                            src="{{ asset('assets-front') }}/images/fashion/product/2.jpg"></a>
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h4>item name</h4>
                                                        </a>
                                            ...
                                            <div class="row m-0">
                                                ...
                                                <div class="col-xl-4">
                                                    <a href="#" class="mega-menu-banner"><img
                                                            src="{{ asset('assets-front') }}/images/mega-menu/fashion.jpg"
                                    ...
                                    <ul class="mega-menu full-mega-menu">
                                        <li>
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <img src="{{ asset('assets-front') }}/images/menu-banner.jpg"
